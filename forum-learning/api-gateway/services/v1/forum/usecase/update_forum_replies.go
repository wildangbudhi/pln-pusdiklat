...
func (usecase *forumUsecase) UpdateForumReplies(requestURI string, requestMethod string, forumReplyID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.UpdateForumReplies(forumReplyID, requestBody, urlQuery, requestHeader)

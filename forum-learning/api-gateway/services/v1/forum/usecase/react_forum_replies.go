...
func (usecase *forumUsecase) ReactForumReplies(requestURI string, requestMethod string, forumReplyID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.ReactForumReplies(forumReplyID, requestBody, urlQuery, requestHeader)

...
func (usecase *forumUsecase) GetForum(requestURI string, requestMethod string, forumID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.GetForum(forumID, requestBody, urlQuery, requestHeader)

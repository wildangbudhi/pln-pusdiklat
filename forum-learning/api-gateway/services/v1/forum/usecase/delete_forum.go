...
func (usecase *forumUsecase) DeleteForum(requestURI string, requestMethod string, forumID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.DeleteForum(forumID, requestBody, urlQuery, requestHeader)

...
func (usecase *forumUsecase) CreateForum(requestURI string, requestMethod string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.CreateForum(requestBody, urlQuery, requestHeader)

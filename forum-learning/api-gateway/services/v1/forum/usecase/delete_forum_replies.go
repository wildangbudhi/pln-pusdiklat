...
func (usecase *forumUsecase) DeleteForumReplies(requestURI string, requestMethod string, forumReplyID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.DeleteForumReplies(forumReplyID, requestBody, urlQuery, requestHeader)

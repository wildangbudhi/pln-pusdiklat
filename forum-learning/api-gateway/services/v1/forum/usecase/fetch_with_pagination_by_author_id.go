...
func (usecase *forumUsecase) FetchWithPaginationByAuthorID(requestURI string, requestMethod string, authorID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.FetchWithPaginationByAuthorID(authorID, requestBody, urlQuery, requestHeader)

...
func (usecase *forumUsecase) UpdateForum(requestURI string, requestMethod string, forumID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.UpdateForum(forumID, requestBody, urlQuery, requestHeader)

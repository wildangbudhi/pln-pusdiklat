...
func (usecase *forumUsecase) FetchReplyByForumIDWithPagination(requestURI string, requestMethod string, forumID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.FetchReplyByForumIDWithPagination(forumID, requestBody, urlQuery, requestHeader)

...
func (usecase *forumUsecase) ReactForum(requestURI string, requestMethod string, forumID string, requestBody io.Reader, urlQuery string, requestHeader map[string][]string) (*http.Response, error) {
	...
	resp, err := usecase.forumRepository.ReactForum(forumID, requestBody, urlQuery, requestHeader)

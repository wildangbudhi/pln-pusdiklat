...
func (s *Server) readConfigFile() error {
	...
	s.Config.MongoDBHost = os.Getenv("MONGODB_HOST")
	s.Config.MongoDBPort = os.Getenv("MONGODB_PORT")
	s.Config.MongoDBUser = os.Getenv("MONGOBD_USER")
	s.Config.MongoDBPassword = os.Getenv("MONGODB_PASSWORD")
	s.Config.MongoDBAuthSrc = os.Getenv("MONGOBD_AUTH_SRC")

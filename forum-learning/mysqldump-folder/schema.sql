...
--
-- Host: localhost    Database: forum_learning
-- ------------------------------------------------------
...
CREATE TABLE `discussion` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `discussion_request_id` bigint(20) DEFAULT NULL,
...
CREATE TABLE `discussion_expertises` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  KEY `discussion_expertises_FK_user_id` (`user_id`),
  ...
  CONSTRAINT `discussion_expertises_FK_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_auth` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `discussion_request_expertise_sugestions` (
  `discussion_request_id` bigint(20) DEFAULT NULL,
  `expertise_user_id` bigint(20) DEFAULT NULL,
  KEY `discussion_request_expertise_sugestions_FK_1` (`expertise_user_id`),
  ...
  CONSTRAINT `discussion_request_expertise_sugestions_FK_1` FOREIGN KEY (`expertise_user_id`) REFERENCES `user_auth` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `discussion_requests` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `reqeuster_user_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `forum_replies_reactions` (
  ...
  `forum_id` bigint(20) NOT NULL,
  `forum_replies_id` bigint(20) NOT NULL,
  `up_vote` tinyint(1) DEFAULT NULL,
  `down_vote` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `role_activities` (
  ...
  `activities_id` bigint(20) DEFAULT NULL,
...
-- Dump completed on 2020-12-17 11:10:20

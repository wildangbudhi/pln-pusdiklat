...
func (usecase *forumUsecase) CloseForum(requestUserID int, requestUserRoles []string, forumID domain.UUID) error {
	...
	rowAffected, err := usecase.forumRepository.UpdateForumStatusByID(forumID, "CLOSED")

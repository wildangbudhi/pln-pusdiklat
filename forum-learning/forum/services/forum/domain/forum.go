...
type ForumRepository interface {
	...
	FetchForumWithUserReaction(offset int, limit int, userID int, topForumSort bool, timelineTimeFrame *TimelineTimeFrame) ([]Forum, error)
	FetchForumByAuthorIDWithUserReaction(authorID int, offset int, limit int, userID int, topForumSort bool) ([]Forum, error)
	FetchForumByCategoryIDWithUserReaction(categoryID int, offset int, limit int, userID int, topForumSort bool, timelineTimeFrame *TimelineTimeFrame) ([]Forum, error)
